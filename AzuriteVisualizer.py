            ...
            if 'subnetItems' in subnet:
                ...
                for subnetItem in subnet['subnetItems']:
                    ...
                    if (subnetItem['itemType'] == 'Virtual Machine'):
                        ...
                        #Below seems to asume that vms have interfaces.

                        if not is_empty(subnetItem['vmNetworkConfiguration']):
                ...
                for subnetItem in subnet['subnetItems']:
                    if (subnetItem['itemType'] == 'Virtual Network Gateway'):
                            ...
                            if 'virtualNetworkGatewayConnections' in subnetItem:
                                ...
                                pprint.pprint(subnetItem)

                                if 'virtualNetworkGatewayConnectionGateway1' in subnetItem['virtualNetworkGatewayConnections'].keys():
